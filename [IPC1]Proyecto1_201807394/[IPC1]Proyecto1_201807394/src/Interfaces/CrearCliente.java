...
public class CrearCliente extends JFrame{
    ...
    public CrearCliente(){
        ...
        txtnombre.setBounds(90, 20, 100, 30);
        add(txtnombre);
        
        nombre = new JTextField();
        nombre.setBounds(90, 60, 210, 30);
        add(nombre);
        
        txtdireccion = new JLabel("Direccion: ");
        txtdireccion.setBounds(90, 100, 100, 30);
        add(txtdireccion);
        
        direccion = new JTextField();
        direccion.setBounds(90, 140, 210, 30);
        add(direccion);
        
        txttelefono = new JLabel("Telefono: ");
        txttelefono.setBounds(90, 180, 100, 30);
        add(txttelefono);
        
        telefono = new JTextField();
        telefono.setBounds(90, 220, 210, 30);
        add(telefono);
    ...
    public void botones(){
            ...
            public void actionPerformed(ActionEvent e){     
                ...
                if(Nombre.length()==0 || Direccion.length()==0 || Telefono.length()==0){
                    ...
                    if(Telefono.length()!=8){
                        ...
                        listaClientes[cClientes] = new Clientes(cClientes, 0, Nombre, Direccion, Telefono);
                        JOptionPane.showMessageDialog(null, "Creacion de Cliente Exitosa", "Banco Del Exterior",JOptionPane.INFORMATION_MESSAGE);
                        cClientes+=1;
                        dispose();
        ...
        cancelar.setBounds(200, 260, 100, 30);
        add(cancelar);
